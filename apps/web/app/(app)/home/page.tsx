    ...
    <div className="flex flex-col items-center min-h-screen bg-gray-50 p-4">
      <div className="w-full max-w-6xl">
            ...
            >
              ...
              <CollapsibleContent className="pt-4">
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">Caption Style</label>
            ...
            <div className="flex-1 flex flex-col items-center justify-center border-2 border-gray-100 rounded-lg">
              {file ? (
                ...
                <div className="flex flex-col items-center justify-center text-center p-6">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Ready to Create Your Video</h3>
                  <p className="text-gray-500">Enter details of the video you want to create</p>
                </div>
              )}
            </div>
          </Card>
        ...
        <div className="mt-16 mb-8">
          <h2 className="text-3xl font-bold text-center mb-8">Example Video Captions</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3].map((item) => (
              <Card key={item} className="overflow-hidden">
                ...
                <div className="p-4">
                  <h3 className="font-semibold mb-2">Example Caption Style {item}</h3>
                  <p className="text-sm text-gray-500">
                    Professional captions with {item === 1 ? 'standard style' : item === 2 ? 'shadow effects' : 'background highlight'}
                  </p>
                </div>
              </Card>
            ))}
        ...
        <div className="my-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-500">Our advanced AI accurately transcribes speech in multiple languages</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-500">Customize font, style, size, and position to match your video</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-500">Download as SRT, VTT or directly embed captions in your video</p>
          </div>
        </div>
      </div>
    </div>
